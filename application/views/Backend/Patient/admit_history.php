            ...
            <div class="ibox-content">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover dataTables-example">
                        ...
                        <tr>
                            <td><?= $allotment->bed_id ?></td>
                            <td><?= $this->Admin_model->getBedby_id($allotment->bed_id)->bed_type ?></td>
                            <td><?= $this->Admin_model->getpatientby_id($allotment->patient_id)->name ?></td>
                            <td><?= $allotment->allotment_time ?></td>
                            <td><?= $allotment->discharge_time ?></td>
