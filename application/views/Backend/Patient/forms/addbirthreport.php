                ...
                <div class="col-lg-10">
                    <div class="input-group date">
                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input required
                            autocomplete="off" type="text" class="form-control" value="03/04/2014">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group"><label class="col-lg-2 control-label">Type</label>
                <div class="col-lg-10">
                    <select required autocomplete="off" data-placeholder="Choose a Country..." class="chosen-select"
                        ...
                        <option value="United States">Operation</option>
                        <option value="United Kingdom">Birth</option>
                        <option value="Afghanistan">Death</option>
                    </select>
                </div>
            </div>
...
$(function() {
    ...
    function previewFile() {
        ...
        var imgdiv = $(document.createElement('div')).append(preview).append(
            '<br><span> <label class="btn btn-xs btn-warning">Remove Image</label></span>');
