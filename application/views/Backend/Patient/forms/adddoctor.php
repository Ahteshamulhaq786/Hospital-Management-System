        ...
        <form class="form-horizontal">
            <form method="get" class="form-horizontal">
                <div class="form-group"><label class="col-sm-2 control-label">Name</label>
                    <div class="col-sm-10"><input required autocomplete="off" type="text" class="form-control"></div>
                </div>
                <div class="form-group"><label class="col-sm-2 control-label">Email</label>
                    <div class="col-sm-10"><input required autocomplete="off" type="email" class="form-control">
                    </div>
                </div>
                <div class="form-group"><label class="col-sm-2 control-label">Password</label>

                    <div class="col-sm-10"><input required autocomplete="off" type="password" class="form-control" name="password"></div>
                </div>
                ...
                <div class="form-group"><label class="col-sm-2 control-label">Phone</label>
                    ...
                    <div class="col-sm-10">
                        <input required autocomplete="off" type="number" class="form-control" name="password">
                    </div>
                </div>
                <div class="form-group"><label class="col-sm-2 control-label">Gender</label>
                    <div class="col-sm-10">
                        <select required autocomplete="off" class="form-control" data-placeholder="Choose a Country...">
                ...
                <div class="form-group"><label class="col-sm-2 control-label">Age</label>
                    ...
                    <div class="col-sm-10">
                        <input required autocomplete="off" type="number" class="form-control" name="age">
                    </div>
                </div>

                <div class="form-group"><label class="col-sm-2 control-label">Blood Group</label>
                    <div class="col-sm-10">
                        <select required autocomplete="off" name="blood_group" class="form-control">
                    ...
                    <div class="col-sm-10">
                        <div class="fileinput fileinput-new input-group" data-provides="fileinput">
                            ...
                            <span class="input-group-addon btn btn-default btn-file">
                                ...
                                <input required type="file" accept="image/*" name="image" id="file" onchange="loadFile(event)">
                            </span>
