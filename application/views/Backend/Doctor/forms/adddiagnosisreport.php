        ...
        <form class="form-horizontal" method="post" action="<?= site_url('index.php/doctor/manage_diagnosis'); ?>" enctype="multipart/form-data">
            <div class="form-group"><label class="col-lg-2 control-label">Time</label>
                <div class="col-lg-10">
                    <div class="input-group">
                        <input type="time" value="<?= isset($_POST['time']) ? $_POST['time'] : $record->time; ?>" autocomplete="off" required class="form-control" name="time">
            ...
            <div class="form-group" id="data_1">
                ...
                <div class="col-lg-10">
                    <div class="input-group date">
                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" name="date" autocomplete="off" required class="form-control" value="<?= isset($_POST['date']) ? $_POST['date'] : $record->date; ?>">
                         <div class="text-danger d-block text-bold">
            ...
            <div class="form-group" id="data_1">
                ...
                <div class="fileinput fileinput-new" data-provides="fileinput">
                    ...
                    <span class="fileinput-exists">Change</span><input type="file" name="custom_report"/></span>
                    <span class="fileinput-filename"></span>
                    <a href="#" class="close fileinput-exists" data-dismiss="fileinput" style="float: none">×</a>
                    <div class="text-danger d-block text-bold">
                        <p style="padding-left: 2px;padding-top: 2px"><?= isset($record->upload_error) ? $record->upload_error : ''; ?></p>
                    </div>
                </div> 
                </div>
            </div>
            ...
            <div class="form-group" id="data_1">
                ...
                <div class="col-lg-10">
                    <textarea name="description"><?= isset($_POST['description']) ? $_POST['description'] : $record->description; ?></textarea>
                    <div class="text-danger d-block text-bold">
