...
<div style="margin:10px;">
    <a href="<?= base_url('index.php/Doctor/bed_allotment') ?>">
...
<div class="row animated fadeInDown">
    <div class="col-lg-10 col-md-10 col-xs-10 col-xs-offset-1 col-md-offset-1 col-lg-offset-1">
        <form class="form-horizontal" action="<?= site_url('index.php/doctor/manage_bedallotments'); ?>" method="post">
        <div class="form-group"><label class="col-lg-2 control-label">Bed Number</label>
                <div class="col-lg-10">
                    <select name="bed_id" data-placeholder="Choose a Country..." class="chosen-select"  required autocomplete="off">
        ...
        <div class="form-group"><label class="col-lg-2 control-label">Select Patient</label>
                <div class="col-lg-10">
                    <select data-placeholder="Choose a Country..." class="chosen-select" name="patient_id"  required autocomplete="off">
            ...
            <div class="form-group" id="data_1">
                ...
                <div class="col-lg-10">
                    <div class="input-group date">
                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" name="allotment_time" required="required" autocomplete="off" class="form-control" value="<?= isset($_POST['allotment_time']) ? $_POST['allotment_time'] : $records->allotment_time; ?>">
                    </div>
                </div>
            </div>
