...
<div style="margin:10px;">
    ...
    <a href="<?= base_url('index.php/Doctor/prescription?pid='.$_GET['pid']) ?>">
...
<div class="row animated fadeInDown">
    <div class="col-lg-10 col-md-10 col-xs-10 col-xs-offset-1 col-md-offset-1 col-lg-offset-1">
        <form class="form-horizontal" method="post" action="<?= site_url('index.php/doctor/manage_prescriptions'); ?>">
            <div class="form-group" id="data_1">
                <label class="col-lg-2 control-label">Date</label>
                <div class="col-lg-10">
                    <div class="input-group date">
                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" autocomplete="off" class="form-control" required name="date" value="<?= isset($_POST['date']) ? $_POST['date'] : $record->date; ?>">
            ...
            <div class="form-group"><label class="col-lg-2 control-label">Time</label>
                <div class="col-lg-10">
                    <div class="input-group">
                        <input type="time" autocomplete="off" required value="<?= isset($_POST['time']) ? $_POST['time'] : $record->time; ?>" class="form-control" name="time">
            ...
            <div class="form-group"><label class="col-lg-2 control-label">Select Patient</label>
                <div class="col-lg-10">
                    <select name="patient_id" data-placeholder="Choose a Country..." autocomplete="off" required class="chosen-select" tabindex="2">
                        <option value="">Select Patient</option>
                        <?php foreach($record->patients as $patient) : ?>
                            <option value="<?= $patient->id; ?>" <?= $record->patient_id==$patient->id ? 'selected' : ''; ?> ><?= $patient->name; ?></option>
                        <?php endforeach; ?>
                    </select>
                    <div class="text-danger d-block text-bold">
            ...
            <div class="form-group"><label class="col-lg-2 control-label">Case History</label>
                <div class="col-lg-10">
                            <textarea name="case_history" class="form-control" rows="4">
                                    <?= isset($_POST['case_history']) ? $_POST['case_history'] : $record->case_history; ?>
                            </textarea>
                        <div class="text-danger d-block text-bold">
                                <p style="padding-left: 2px;padding-top: 2px"><?= form_error('case_history'); ?></p>
                            </div>
                </div>
            </div>
            <div class="form-group"><label class="col-lg-2 control-label">Meditation</label>
                <div class="col-lg-10">
                            <textarea name="meditation" class="form-control" rows="4">
                                    <?= isset($_POST['meditation']) ? $_POST['meditation'] : $record->meditation; ?>
                            </textarea>
                        <div class="text-danger d-block text-bold">
                                <p style="padding-left: 2px;padding-top: 2px"><?= form_error('meditation'); ?></p>
                        </div>
                </div>
            </div>
            <div class="form-group"><label class="col-lg-2 control-label">Note</label>
                <div class="col-lg-10">
                            <textarea name="note" class="form-control" rows="4">
                                <?= isset($_POST['note']) ? $_POST['note'] : $record->note; ?>
                            </textarea>
                        <div class="text-danger d-block text-bold">
                                <p style="padding-left: 2px;padding-top: 2px"><?= form_error('note'); ?></p>
                            </div>
                </div>
            </div>
    </div>
