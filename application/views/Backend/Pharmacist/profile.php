        ...
        <div class="col-md-10 col-12">
            ...
            <div class="tab-content" id="v-pills-tabContent">
                <div class="tab-pane fade show active" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                    <form method="post" action="<?= base_url('index.php/pharmacist/manage_profile'); ?>" enctype="multipart/form-data">
                ...
                <div class="tab-pane fade" id="v-pills-security" role="tabpanel" aria-labelledby="v-pills-home-tab">
                    ...
                    <form method="post" action="<?= base_url('index.php/pharmacist/edit_pass'); ?>">
                        <div class="form-group row">
