...
<head>
    ...
    <title>Pharmacist | @provide(title)</title>
        ...
        <aside class="mdc-drawer mdc-drawer--dismissible mdc-drawer--open">
            <div class="mdc-drawer__header">
                <img style="border-radius: 100px;width:64px;height: 64px; margin-top:35px"
                    src="<?= $this->Admin_model->getpharmacistby_id($_SESSION['PROFILE_ID'])->icon; ?>" alt="">
                <h4 style="margin: 10px 0 0 8px;">
                    <font color="white"><?= $this->Admin_model->getpharmacistby_id($_SESSION['PROFILE_ID'])->name; ?>
                    </font>
                </h4>
            </div><br>
                                ...
                                <nav class="mdc-list mdc-drawer-submenu">
                                    <div class="mdc-list-item mdc-drawer-item">
                                        <a class="mdc-drawer-link"
                                            href="<?= base_url('index.php/Pharmacist/managemedicine') ?>">
                                            Manage Medicines
                                        </a>
                                    </div>
                                    <div class="mdc-list-item mdc-drawer-item">
                                        <a class="mdc-drawer-link"
                                            href="<?= base_url('index.php/Pharmacist/orders') ?>">
                                            Medicine Orders
                                        </a>
                                    </div>
                                    <div class="mdc-list-item mdc-drawer-item">
                                        <a class="mdc-drawer-link"
                                            href="<?= base_url('index.php/Pharmacist/medicinesales') ?>">
                                            Medicine Sales
                                        </a>
                                    </div>
                                </nav>
                        ...
                        <div class="menu-button-container menu-profile d-none d-md-block">
                            <button class="mdc-button mdc-menu-button">
                                <span class="d-flex align-items-center">
                                    <span class="figure">
                                        <img src="<?= $this->Admin_model->getpharmacistby_id($_SESSION['PROFILE_ID'])->icon; ?>"
                                            alt="user" class="user" />
                                    </span>
                                    <span
                                        class="user-name"><?= $this->Admin_model->getpharmacistby_id($_SESSION['PROFILE_ID'])->name; ?></span>
                                </span>
                            </button>
                                    ...
                                    <li class="mdc-list-item" role="menuitem">
                                        ...
                                        <div
                                            ...
                                            <a style="text-decoration: none;"
                                                href="<?= base_url('index.php/Pharmacist/profile') ?>">
                    ...
                    <div class="mdc-layout-grid">
                        <div class="mdc-layout-grid__inner">
                            <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop">
                                <span class="text-center text-sm-left d-block d-sm-inline-block tx-14">Copyright © 2021
