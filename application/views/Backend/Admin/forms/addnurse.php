...
@section(title)Manage Nurse@endsection
@section(links)
<!-- SweetAlert2 -->
...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Manage Nurses</h3>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
        <form role="form" action="<?= site_url('index.php/admin/manage_nurses');?>" method="post" enctype="multipart/form-data">
            <div class="form-group row">
                <label for="" class="col-12 col-md-3 text-center control-label">Name</label>

                <div class="col-12 col-md-7">
                    <input type="text" value="<?php echo isset($record->name) ? $record->name : set_value('name');?>" name="name" class="form-control" id="name"  required autocomplete="off">
            ...
            <div class="form-group row">
                ...
                <div class="col-12 col-md-7">
                    <input type="email" name="email" class="form-control" id="email"  required autocomplete="off" value="<?php echo isset($record->email) ? $record->email : set_value('email');?>">
                    <div class="invalid-feedback text-danger d-block text-bold">
                        <?= form_error('email'); ?>
                    </div>
                </div>
