...
@section(title)Manage Patient@endsection
@section(links)
<!-- SweetAlert2 -->
...
<div class="card">
    ...
    <!-- /.card-header -->
    <div class="card-body">
        <form role="form" action="<?= site_url('index.php/admin/manage_patients');?>" method="post" enctype="multipart/form-data">
            <div class="form-group row">
                <label for="" class="col-12 col-md-3 text-center control-label">Name</label>

                <div class="col-12 col-md-7">
                    <input required autocomplete="off" type="text" value="<?php echo isset($record->name) ? $record->name : set_value('name');?>" name="name" class="form-control" id="name" required>
            ...
            <div class="form-group row">
                ...
                <div class="col-12 col-md-7">
                    <input required autocomplete="off" type="email" name="email" class="form-control" id="email" required value="<?php echo isset($record->email) ? $record->email : set_value('email');?>">
                    <div class="invalid-feedback text-danger d-block text-bold">
                        <?= form_error('email'); ?>
                    </div>
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-12 col-md-7">
                    <textarea name="address" name="address" class="form-control" id="address" rows="5"><?php echo isset($record->address) ? $record->address : set_value('address');?></textarea>
                    <div class="invalid-feedback text-danger d-block text-bold">
                        <?= form_error('address'); ?>
                    </div>
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-12 col-md-7">
                    <input required autocomplete="off" type="text" required value="<?php echo isset($record->phone) ? $record->phone : set_value('phone');?>" name="phone" class="form-control" id="phone">
                    <div class="invalid-feedback text-danger d-block text-bold">
                        <?= form_error('phone'); ?>
                    </div>
                </div>
            ...
            <div class="form-group row">
                <label for="" class="col-12 col-md-3 text-center control-label">Birth Date</label>

                <div class="col-12 col-md-7">
                    <input required autocomplete="off" type="date" class="form-control" id="birthday" name="birth_date" value="<?php echo isset($record->birth_date) ? $record->birth_date : set_value('birth_date');?>">
                    <div class="invalid-feedback text-danger d-block text-bold">
            ...
            <div class="form-group row">
                ...
                <div class="col-12 col-md-7">
                    <input required autocomplete="off" type="number" class="form-control" id="birthday" name="age" value="<?php echo isset($record->age) ? $record->age : set_value('age');?>">
                    <div class="invalid-feedback text-danger d-block text-bold">
                        <?= form_error('age'); ?>
                    </div>
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-12 col-md-7">
                    <select name="gender" class="form-control"  required autocomplete="off">
                        ...
                        <option value="male" <?php echo ($record->gender_id=="male") ? "selected" : '';?>
                        >Male</option>
                        <option value="female" <?php echo ($record->gender_id=="female") ? "selected" : '';?>
                        >FeMale</option>
            ...
            <div class="form-group row">
                ...
                <div class="col-12 col-md-7">
                    <select name="blood_group" class="form-control"  required autocomplete="off">

                        <option value="">Select Blood Group</option>
                        <option value="A+" <?= ($record->blood_group_id=="A+") ? "selected" : '';?>
                        >A+</option>
                        <option value="A-" <?= ($record->blood_group_id=="A-") ? "selected" : '';?>
                        >A-</option>
                        <option value="B+" <?= ($record->blood_group_id=="B+") ? "selected" : '';?>
                        >B+</option>
                        <option value="B-" <?= ($record->blood_group_id=="B-") ? "selected" : '';?>
                        >B-</option>
                        <option value="AB+" <?= ($record->blood_group_id=="AB+") ? "selected" : '';?>
                        >AB+</option>
                        <option value="AB-" <?= ($record->blood_group_id=="AB-") ? "selected" : '';?>
                        >AB-</option>
                        <option value="O+" <?= ($record->blood_group_id=="O+") ? "selected" : '';?>
                        >O+</option>
                        <option value="O-" <?= ($record->blood_group_id=="O-") ? "selected" : '';?>
                        >O-</option>
