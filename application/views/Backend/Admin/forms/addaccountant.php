...
@section(title)Manage Accountant@endsection
@section(links)
<!-- SweetAlert2 -->
...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Manage Accountants</h3>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
        <form role="form" action="<?= site_url('index.php/admin/manage_accountants');?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-12 col-md-7">
                    <input required autocomplete="off" type="text" name="password" class="form-control" id="password" value="<?php echo isset($record->password) ? $record->password : set_value('password');?>">
                    <div class="invalid-feedback text-danger d-block text-bold">
                        <?= form_error('password'); ?>
                    </div>
                </div>
...
unset($_SESSION['upload_errors']); ?>
            ...
            <input required autocomplete="off" type="hidden" id="old_img_1" name="old_img" value="<?= $d; ?>">
            <div class="form-group row">
