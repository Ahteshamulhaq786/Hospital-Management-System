...
@section(title)Manage Laboratorist@endsection
@section(links)
<!-- SweetAlert2 -->
...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Manage Laboratorists</h3>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
        <form role="form" action="<?= site_url('index.php/admin/manage_laboratorists');?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-12 col-md-7">
                    <textarea name="address" class="form-control" id="address" rows="5" required><?php echo isset($record->address) ? $record->address : set_value('address');?></textarea>
                    <div class="invalid-feedback text-danger d-block text-bold">
                        <?= form_error('address'); ?>
                    </div>
                </div>
